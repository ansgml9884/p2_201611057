...
def Only_():
    print "Only Lincoln words :",w_L.difference(w_B)
    print "Only Bush words :",w_B.difference(w_L)

def Both(): 
    print "Both Lincoln and Bush :",w_L.intersection(w_B) 
def All(): 
    print "ALL of Frequent words:",w_L.union(w_B) 


d_L=dict()
d_B=dict()

d_L=countWords(Lincoln)
d_B=countWords(Bush)
    
w_L=set()
w_B=set()

w_L=FrequentWordsList(8,d_L)
w_B=FrequentWordsList(23,d_B)    
...
def lab11_3():
    ...
    print "Frequent words of Lincoln :",w_L
    print "Frequent words of Bush :",w_B
